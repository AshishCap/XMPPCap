...
- (void)customArchiveMessage:(XMPPMessage *)message outgoing:(BOOL)isOutgoing xmppStream:(XMPPStream *)xmppStream
{
    ...
    [self.xmppMessageArchivingCoreDataStorage scheduleBlock:^{
        ...
        /*
        XMPPMessageArchiving_Message_CoreDataObject *archivedMessage = [self.xmppMessageArchivingCoreDataStorage composingMessageWithJid:messageJid streamJid:myJid outgoing:isOutgoing managedObjectContext:moc];
